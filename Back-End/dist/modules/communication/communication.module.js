...
const communication_service_controller_2 = require("./communication.service-controller");
...
exports.CommunicationModule = CommunicationModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([message_entity_1.MessageEntity, channel_entity_1.ChannelEntity]), jwt_1.JwtModule.registerAsync({
                useFactory: () => ({
                    secret: process.env.JWT_SECRET,
                    signOptions: { expiresIn: '7d' },
                }),
            }),],
        providers: [communication_gateway_1.CommunicationGateway, communication_service_controller_1.CommunicationService],
        controllers: [communication_service_controller_2.CommunicationController],
